...
favicon.href = '/assistara-logo.svg?v=5';
...
shortcutFavicon.href = '/assistara-logo.svg?v=5';
  ...
  siteFooter.innerHTML = `
    <div class="shell assistara-footer-main">
      ...
      <div class="assistara-footer-links">
        ...
        <a href="#roles">What you can delegate</a>
        <a href="/academy">Assistara Academy</a>
      </div>
    ...
    <div class="shell assistara-footer-bottom">
      <span>© 2026 Assistara</span>
      <span>Trained. Vetted. Matched around your work.</span>
    </div>`;

  const footerStyles = document.createElement('style');
  footerStyles.textContent = `
    body > footer{background:#111!important;color:#fff!important;padding:0!important;overflow:hidden}
    .assistara-footer-main{display:grid;grid-template-columns:1.15fr .7fr 1fr;gap:70px;padding:72px 0 54px;align-items:start}
    .assistara-footer-brand .brand{width:max-content;font-size:24px;margin-bottom:22px}
    .assistara-footer-brand .mark{width:42px;height:42px}
    .assistara-footer-brand p{margin:0;max-width:410px;color:#9d9d9d;font-size:17px;line-height:1.6}
    .assistara-footer-links,.assistara-footer-contact{display:flex;flex-direction:column;align-items:flex-start;gap:13px}
    .assistara-footer-links>span,.assistara-footer-contact>span{font-size:11px;letter-spacing:.14em;font-weight:800;color:#666;margin-bottom:5px}
    .assistara-footer-links a{color:#c8c8c8;font-size:15px;transition:.2s ease}
    .assistara-footer-links a:hover{color:#fff;transform:translateX(3px)}
    .assistara-email{display:inline-flex;align-items:center;gap:9px;color:#fff;font:700 18px/1.25 Manrope,sans-serif;border-bottom:1px solid #3b3b3b;padding-bottom:6px;transition:.2s ease}
    .assistara-email b{color:#ffd51f;font-size:16px}
    .assistara-email:hover{border-color:#ffd51f;color:#ffd51f}
    .assistara-footer-cta{display:inline-flex;align-items:center;gap:10px;margin-top:12px;background:#ffd51f;color:#111!important;border-radius:999px;padding:14px 18px;font-weight:800;transition:.2s ease}
    .assistara-footer-cta:hover{transform:translateY(-2px)}
    .assistara-footer-bottom{border-top:1px solid #292929;display:flex;justify-content:space-between;gap:20px;padding:20px 0 24px;color:#666;font-size:12px}
    @media(max-width:850px){.assistara-footer-main{grid-template-columns:1fr 1fr;gap:42px}.assistara-footer-brand{grid-column:1/-1}.assistara-footer-brand p{max-width:600px}}
    @media(max-width:620px){.assistara-footer-main{grid-template-columns:1fr;gap:34px;padding:52px 0 38px}.assistara-footer-brand{grid-column:auto}.assistara-footer-bottom{flex-direction:column;gap:7px}.assistara-email{font-size:16px;word-break:break-word}.assistara-footer-cta{width:100%;justify-content:center}}
  `;
